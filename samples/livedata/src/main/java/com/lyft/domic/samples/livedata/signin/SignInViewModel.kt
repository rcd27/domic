package com.lyft.domic.samples.livedata.signin
...
class SignInViewModel(view: SignInView, service: SignInService) : Disposable {
    ...
    companion object {
//        TODO rcd: implement. See: https://medium.com/@BladeCoder/kotlin-singletons-with-argument-194ef06edd9e
//        val instance: SignInViewModel = SignInViewModel(view, service)
    }
